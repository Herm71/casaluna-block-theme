jQuery( document ).ready( function ( $ ) {
	$( '.trip-download-div' )
		.has( '#wptravel-trip-downloads-block' )
		.css( 'display', 'block' );

	$( '.trip-sale-div' )
		.has( '#wptravel-block-trip-sale' )
		.css( 'display', 'block' );

	$( '.trip-facts-div' )
		.has( '#wptravel-block-trip-fact' )
		.css( 'display', 'block' );

	$(
		"<div id='close-enquiry'><i class='fa fa-times' aria-hidden='true'></i></div>"
	).insertBefore( '.wp-travel-enquiries-form-wrapper' );
